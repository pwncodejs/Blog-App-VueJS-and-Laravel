...
export const allBlogs = (params) => api.post(resource+'/all', params);

export const blogsBySearch = (search) =>
    api.post(`${resource}/blogsBySearch`, search);
...
export const searchBlogs = (search) =>
    api.post(`${apiPath}/searchBlogs`, search);
