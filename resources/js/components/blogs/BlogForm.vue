    ...
    <div class="container">
        ...
        <div class="row mt-6">
            ...
            <div class="col-6">
                ...
                <router-link  :to="{name:'dashboard'}" class="me-3 btn btn-outline-secondary mb-3 float-end">Back</router-link>
            </div>
        ...
        <div class="row">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control" :class="{'is-invalid' : errors.title && errors.title[0]}" id="title" v-model="formData.title">
                            <label class="invalid-feedback" v-if="errors.title && errors.title[0]">{{ errors.title && errors.title[0] }}</label>
                        </div>
                        <div class="mb-3">
                            <label for="task-text" class="col-form-label" :class="{'is-invalid' : errors.blog_content && errors.blog_content[0]}">Body:</label>
                            <QuillEditor contentType="html" theme="snow" toolbar="full" v-model:content="formData.blog_content" />
                            <label class="invalid-feedback" v-if="errors.blog_content && errors.blog_content[0]">{{ errors.blog_content && errors.blog_content[0] }}</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 px-3">
                <div class="card shadow">
                    <div class="card-body">
                        <label for="file" class="col-form-label" :class="{'is-invalid' : errors.cover_photo && errors.cover_photo[0]}">Upload Blog Cover Photo</label>
                        <input type="file" id="file" class="form-control" accept="image/*" @change="onFileChange" />
                        <label class="invalid-feedback" v-if="errors.cover_photo && errors.cover_photo[0]">{{ errors.cover_photo && errors.cover_photo[0] }}</label>
...
<style>
.ql-container{ min-height: 250px !important;}
</style>
