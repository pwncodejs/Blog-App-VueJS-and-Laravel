                        ...
                        <form action="javascript:void(0)" @submit="handleSubmit" class="row" method="post">
                            ...
                            <div class="form-group col-12">
                                <label for="name" class="font-weight-bold"
                                    :class="{ 'is-invalid': errors.name && errors.name[0] }">Name</label>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="name" v-model="user.username" id="name"
                            ...
                            <div class="form-group col-12 my-2">
                                <label for="email" class="font-weight-bold"
                                    :class="{ 'is-invalid': errors.email && errors.email[0] }">Email</label>
                            ...
                            <div class="form-group col-12">
                                <label for="password" class="font-weight-bold"
                                    :class="{ 'is-invalid': errors.password && errors.password[0] }">Password</label>
