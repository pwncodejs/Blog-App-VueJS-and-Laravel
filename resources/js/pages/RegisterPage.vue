                ...
                <div class="card shadow sm">
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" @submit="handleSubmit" class="row" method="post">
                            ...
                            <div class="form-group col-12">
                                <label for="name" class="font-weight-bold" :class="{ 'is-invalid': errors.username && errors.username[0] }">Username</label>
                                <input type="text" name="name" v-model="user.username" id="name" placeholder="Enter username" class="form-control">
